    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 main-content">
            ...
            <div class="box-content">
                ...
                @endif
                <!--- Form Field --->
                    {!! Form::model($project, ['route' => ['projects.update', $project->id], 'method'=>'PUT', 'id' => 'submit-form']) !!}
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <div class="checkbox no-margin col-sm-6 input-col">
                                    <label>
                                        {!! Form::checkbox('rwly[]', $value, is_array($temp = old('rwly') ? old('rwly') : $project->rwly) && in_array($value,$temp)? true: false) !!} {{$name}}
                                    </label>
                                </div>
                                @endforeach
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($options['ssgmjjhy'] as $value=>$name)
                                <div class="checkbox no-margin col-sm-6 input-col">
                                    <label>
                                        {!! Form::checkbox('ssgmjjhy[]', $value, is_array($temp = old('ssgmjjhy') ? old('ssgmjjhy') : $project->ssgmjjhy) && in_array($value,$temp)? true: false) !!} {{$name}}
                                    </label>
                                </div>
                            @endforeach
                        </td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary cancel" href="{{route('projects.show', $project->id)}}">确定离开</button>
                        </div>
                    </div>
                </div>
            </div>
