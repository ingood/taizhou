        ...
        <div class="col-md-10 col-md-offset-1 main-content">
            ...
            <div class="box-content">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td class="table-label text-left">项目所属科学技术领域、主要内容、特点及应用推广情况<code>(不超过800个汉字)</code>:</td>
                    </tr>
                    <tr>
                        <td>{!! Form::textarea('xmjj', old('xmjj'), ['class'=>'form-control', 'rows'=>20]) !!}</td>
                    </tr>
                </table>
                {!! Form::close() !!}
            </div>
