    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 main-content">
            <div class="box-header">
                <h3 class="text-center">发现、发明及创新点</h3>
            </div>
            <div class="box-content">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td class="table-label text-left">发现、发明及创新点<code>(不超过800个汉字)</code>:</td>
                    </tr>
                    <tr>
                        <td>{!! Form::textarea('jscx', old('jscx'), ['class'=>'form-control', 'rows'=>10]) !!}</td>
                    </tr>
                    <tr>
                        <td class="table-label text-left">保密要点<code>(不超过100个汉字)</code>:</td>
                    </tr>
                    <tr>
                        <td>{!! Form::textarea('bmyd', old('bmyd'), ['class'=>'form-control', 'rows'=>8]) !!}</td>
                    </tr>
                </table>
                {!! Form::close() !!}
            </div>
