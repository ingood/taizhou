        ...
        <div class="col-md-10 col-md-offset-1 main-content">
            ...
            <div class="box-content">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td class="table-label text-left">与当前国内外同类研究、同类技术的综合比较<code>(不超过800个汉字)</code>:</td>
                    </tr>
                    <tr>
                        <td>{!! Form::textarea('zhbj', old('zhbj'), ['class'=>'form-control', 'rows'=>20]) !!}</td>
                    </tr>
                </table>
                {!! Form::close() !!}
            </div>
